...
function EvaluerFixe() {
    ...
    const anciennete = parseInt(window.document.querySelector("#i_anciennete").value);
...
function EvaluerComXSpirit() {
    ...
    const nbVendus = parseInt(window.document.querySelector("#i_ventes_xspirit").value);
    const tauxCom = 0.06;
...
function EvaluerComMultitec() {
    ...
    const nbVendus = parseInt(window.document.querySelector("#i_ventes_multitec").value);
...
function EvaluerComS20() {
    // Prix du casque et récupération du nombre de ventes ainsi que le taux de com
    const prixS20 = 140;
    const nbVendus = parseInt(window.document.querySelector("#i_ventes_s20").value);
    const tauxCom = 0.02;
...
window.addEventListener("load", function () {
    window.document.querySelector("#btnEstimer").addEventListener("click", function () {
        ...
        window.document.querySelector("#lblEstimation").innerHTML = estimation.toFixed(2) +" €";
    }, false);
}, false);